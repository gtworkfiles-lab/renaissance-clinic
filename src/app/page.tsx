...
export default function Home() {
  ...
  useEffect(() => {
    getContent().then(data => {
      // SEO Оптимізація заголовків "на льоту"
      if (data) {
        data.metadata.siteName = "Ренесанс Центр Чернівці";
        data.hero.title = "Лікування алкоголізму та наркоманії у Чернівцях";
        data.hero.subtitle = "Анонімна допомога 24/7. Отримайте безкоштовну консультацію нарколога прямо зараз. Понад 15 років досвіду в реабілітації.";
  ...
  return (
    <main className="min-h-screen bg-white relative">
      {/* Крок №1: SEO Meta Tags */}
      <title>Лікування алкоголізму Чернівці | Безкоштовна консультація | Ренесанс Центр</title>
      <meta name="description" content="Ренесанс Центр Чернівці — професійне лікування алкоголізму, наркоманії та ігроманії. Анонімна детоксикація, виїзд лікаря додому 24/7. Консультація безкоштовна!" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="p-8 md:p-10 bg-white rounded-[30px] md:rounded-[40px] shadow-sm border border-gray-100 flex flex-col items-center text-center">
              ...
              <div className="flex gap-4">
                {/* Месенджери будуть посилені на наступному кроці */}
