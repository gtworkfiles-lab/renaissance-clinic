...
export async function getContent() {
  return {
    metadata: {
      // Змінено для кращого впізнавання бренду та SEO за запитом "ренесанс"
      siteName: "Ренесанс Центр Чернівці", 
      siteDescription: "Анонімна допомога та психологічна підтримка 24/7. Професійна реабілітація у Чернівцях. Поверніть спокій у власну родину.",
    },
    navigation: {
      menuItems: [
    ...
    hero: {
      // Замінено "лікування" на "допомога" для безпеки реклами
    ...
    services: [
      { 
        ...
        // Додано бренд у заголовок для залучення тих, хто шукає саме вас
...
Одужання сім'ї — це запорука успіху пацієнта.`
    ...
    form: {
      ...
      subtitle: "Залиште заявку, ми передзвонимо вам анонімно протягом 15 хвилин.",
